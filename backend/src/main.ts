...
// TypeORM loads database drivers dynamically. Keeping a direct import ensures
// Vercel traces and packages the PostgreSQL driver with the serverless function.
import 'pg';
